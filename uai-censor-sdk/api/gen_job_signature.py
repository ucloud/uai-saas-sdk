...
class UAICensorGenJobSignatureApi(object):

    def __init__(self, config_file, url='', job_id=''):
    ...
    def call_api(self):
        ...
        signature = gen_signature(self.config_file, timestamp, self.url, self.job_id)
