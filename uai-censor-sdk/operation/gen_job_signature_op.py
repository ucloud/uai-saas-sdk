from api.gen_job_signature import UAICensorGenJobSignatureApi
...
class UAICensorGenJobSignatureOp(UAICensorBaseControllerOperation):

    def __init__(self, parser):
        super(UAICensorGenJobSignatureOp, self).__init__(parser)
        self.params = {}
    ...
    def cmd_run(self, args):
        ...
        caller = UAICensorGenJobSignatureApi(config_file=self.config_file,
                                             url=self.url,
                                             job_id=self.job_id)
