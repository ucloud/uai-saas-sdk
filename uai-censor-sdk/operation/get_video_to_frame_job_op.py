...
class UAICensorGetVideoToFrameJobOp(UAICensorBaseDatastreamOperation):
    def __init__(self, parser):
        super(UAICensorGetVideoToFrameJobOp, self).__init__(parser)
    ...
    def _add_video_job_args(self, parser):
        ...
        args_parser.add_argument(
            ...
            type=str,
            required=True,
            help='Job id of video toframe job'
        )
    ...
    def _add_args(self):
        super(UAICensorGetVideoToFrameJobOp, self)._add_args()
        self._add_video_job_args(self.parser)

    def _parse_args(self, args):
        super(UAICensorGetVideoToFrameJobOp, self)._parse_args(args)
        self._parse_video_job_args(args)

    def cmd_run(self, args):
        self._parse_args(args)

        caller = UAICensorGetAsyncToFrameJobApi(signature=self.signature,
