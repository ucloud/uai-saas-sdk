...
class GetUAIOcrResourceRecordInfoApi(UAIOcrBaseControllerApi):

    ACTION_NAME = "GetUAIOcrResourceRecordInfo"

    def __init__(self, begin_time, end_time, public_key, private_key, region='', zone='', project_id='', resource_id='', limit=0, offset=0):
        super(GetUAIOcrResourceRecordInfoApi, self).__init__(self.ACTION_NAME, public_key, private_key, region, zone, project_id)
    ...
    def call_api(self):
        return super(GetUAIOcrResourceRecordInfoApi, self).call_api()