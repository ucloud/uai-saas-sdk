...
class ModifyUAIOcrResourceOssInfoApi(UAIOcrBaseControllerApi):

    ACTION_NAME = "ModifyUAIOcrResourceOssInfo"

    def __init__(self, resource_id, oss_public_key, oss_private_key, public_key, private_key, region='', zone='', project_id=''):
        super(ModifyUAIOcrResourceOssInfoApi, self).__init__(self.ACTION_NAME, public_key, private_key, region, zone, project_id)
    ...
    def call_api(self):
        return super(ModifyUAIOcrResourceOssInfoApi, self).call_api()